...
export default {
  ...
  data () {
    return {
      ...
      byDate: 'Any time',
      links1: [
        { icon: 'web', text: 'Indexadmin' },
        { icon: 'assignment_ind', text: 'LihatUser' }
      ],
      links2: [
        { icon: 'perm_data_setting', text: 'DaftarMokas', name: 'DaftarMokas', Path: 'DaftarMokas' },
        { icon: 'settings_applications', text: 'DaftarVespa', name: 'DaftarVespa' },
        { icon: 'directions_bike', text: 'DaftarHurley' }
      ]
    }
  },
  methods: {
